public class IdeaPadConfigTool.ControllerBatteryConservative {
    private BatteryConservative model;
    private WidgetIdeaPadMode view;

    public ControllerBatteryConservative(BatteryConservative model, WidgetIdeaPadMode view) {
            this.model = model;
            this.view = view;
    }
